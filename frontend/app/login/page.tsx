    ...
    return (
        <div className="flex min-h-screen bg-black text-white w-full max-w-none !px-0 !py-0 m-[-24px]">
            ...
            <div className="hidden lg:flex w-1/2 flex-col justify-between p-12 bg-zinc-950/40 relative overflow-hidden border-r border-zinc-800/50">
                ...
                <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-brand/10 rounded-full blur-[120px] pointer-events-none mix-blend-screen" />
                ...
                <div className="relative z-10 max-w-md">
                    ...
                    <p className="text-zinc-400 text-lg">Sign in to view your past analyses, track your progress, and get tailored recommendations to level up your engineering skills.</p>
                </div>
            </div>
            ...
            <div className="flex w-full lg:w-1/2 items-center justify-center p-8 lg:p-24 relative">
                <div className="w-full max-w-sm">
                    <div className="mb-10 text-center lg:text-left">
                        ...
                        <p className="text-zinc-400">Enter your details to sign in to your account.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                        ...
                        <p className="text-sm mt-8 text-center text-zinc-500 font-medium">
                            Don't have an account? <Link href="/register" className="text-white hover:text-brand-light transition-colors ml-1">Register now</Link>
                        </p>
                    </form>
                </div>
            </div>
